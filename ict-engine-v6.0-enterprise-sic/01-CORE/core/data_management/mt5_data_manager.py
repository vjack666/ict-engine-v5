...
FTMO_CONFIG = {
    ...
    "magic_number": 20250807,  # Actualizado para v6.0
...
class MT5DataManager:
    ...
    def _initialize_sic_integration(self):
        ...
        try:
            ...
            self.connection_info.debug_level = debugger._debug_level
    ...
    def _get_pandas_lazy(self):
        ...
        if 'pandas' in self._lazy_modules:
            ...
            try:
                ...
                _log_error("❌ pandas no está disponible")
                return None
