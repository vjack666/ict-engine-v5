...
try:
    from core.smart_trading_logger import log_info as _log_info, log_warning as _log_warning, log_error as _log_error
...
if enterprise_logging_available:
    ...
    if enums_available:
        ...
        log_warning("⚠️ Usando fallback enums", "init")
else:
...
class OptimizedICTAnalysisEnterprise:
    ...
    Adaptado para SIC v3.1 Enterprise
    """
    ...
    def calcular_bias_h4_optimizado(self, df_h4: pd.DataFrame) -> Dict[str, Any]:
        """
    ...
    def analizar_confirmacion_ltf(self, df_m5: pd.DataFrame, m15_structure: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            m15_type = m15_structure.get("type", "unknown")
...
# =============================================================================
    ...
    def analyze_symbol(self, symbol: str, timeframes: List[str] = None, mode: str = 'full') -> Dict[str, Any]:
        """
