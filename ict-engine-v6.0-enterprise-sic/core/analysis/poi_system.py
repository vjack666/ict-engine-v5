...
class POISystem:
    ...
    def _detect_order_block_pois(self, data: pd.DataFrame, symbol: str, timeframe: str) -> List[POI]:
    ...
    def _detect_fvg_pois(self, data: pd.DataFrame, symbol: str, timeframe: str) -> List[POI]:
    ...
    def _detect_swing_point_pois(self, data: pd.DataFrame, symbol: str, timeframe: str) -> List[POI]:
    ...
    def _detect_session_level_pois(self, data: pd.DataFrame, symbol: str, timeframe: str) -> List[POI]:
    ...
    def _detect_liquidity_pool_pois(self, data: pd.DataFrame, symbol: str, timeframe: str) -> List[POI]:
    ...
    def _detect_fibonacci_pois(self, data: pd.DataFrame, symbol: str, timeframe: str) -> List[POI]:
    ...
    def _detect_psychological_level_pois(self, data: pd.DataFrame, symbol: str, timeframe: str) -> List[POI]:
