...
class AnalysisInput:
    ...
    def __post_init__(self):
        ...
        enviar_senal_log(
            nivel='DEBUG',
            mensaje=f"📥 AnalysisInput created | ID: {self.analysis_id} | "
...
class ComponentResult:
    ...
    def __post_init__(self):
        ...
        enviar_senal_log(
            ...
            mensaje=f"🎖️ ComponentResult | {self.component_type.value} | "
...
class AnalysisOutput:
    ...
    def __post_init__(self):
        ...
        enviar_senal_log(
            nivel='INFO',
            mensaje=f"📤 AnalysisOutput completed | ID: {self.analysis_id} | "
