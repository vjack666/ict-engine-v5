...
def test_poi_logging_migration():
    """
    🧪 FUNCIÓN DE TESTING - MIGRACIÓN DE LOGGING POI
    ===============================================

    Verifica que el nuevo sistema de logging centralizado funcione correctamente.
    """
    try:
        enviar_senal_log("INFO", "🧪 Iniciando test de migración de logging POI", "poi_detector", "testing")
        ...
        # Test 3: Verificar que log_poi está disponible
        try:
        ...
        enviar_senal_log("ERROR", f"❌ Test de logging POI falló: {e}", "poi_detector", "testing")
        return {
...
def log_poi_centralizado(component: str, message: str, is_error: bool = False):
    """
    Función de logging POI que usa el sistema central SLUC v2.1
    Reemplaza la función obsoleta log_poi_to_csv
    """
...
def detectar_todos_los_pois(df: pd.DataFrame, timeframe: str = "M15",
    ...
    try:
        ...
        log_poi_centralizado("DETECCION_COMPLETA_ERROR", f"Error crítico en TF {timeframe}: {e}", is_error=True)
        return todos_los_pois
